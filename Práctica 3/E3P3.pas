...
begin
    with n do begin
        write(#10,'Enter novel`s code: ');
        readln(code);
        if(n.code <> 0)then begin
            write('Enter novel`s genre: ');
            readln(genre);
            write('Enter novel`s name: ');
            readln(novel_name);
            write('Enter novel`s duration(minutes): ');
            readln(duration);
            write('Enter novel`s director'+Chr(39)+'s name: ');
            readln(director_name);
            write('Enter novel`s price: ');
            readln(sale_price);                
        end;
    end;
end;
...
procedure show_maintenance_menu(var f:novel_file);
    ...
    var
        ...
        str:string;
    begin
        write(#10,'ENTER FILE PATH AND FILE NAME: ');
        readln(str);
        assign(f, str);
